...
int main() {
    ...
    do{
        ...
        cout<<"4) suma del bulto2 y bulto3"<<endl;
        cout<<"5) resta de X gramos al bulto tres"<<endl;
        cout<<"6) resta de bultos bul1-bul2"<<endl;
        cout<<"7) bulto > bulto2"<<endl;
        cout<<"8) bulto1 < bulto2"<<endl;
        cout<<"9) bulto1 == bulto2"<<endl;
        cout<<"10) Salir"<<endl;
        cin >> op;
        switch (op){
                //
